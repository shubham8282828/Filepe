...
# Global application instance (used by webhook route)
...
def webhook():
    ...
    try:
        ...
        loop.run_until_complete(_bot_application.process_update(update))
    except Exception as e:
...
def main():
    ...
    # Initialize bot application synchronously before Flask starts
    loop = asyncio.new_event_loop()
    ...
    # Flask handles everything — bot updates come via webhook
